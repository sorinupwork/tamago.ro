  ...
  return (
    <div style={{ fontFamily: 'Arial, sans-serif', maxWidth: '600px', margin: '0 auto', padding: '20px' }}>
      ...
      <p style={{ color: '#666', lineHeight: '1.6' }}>
        Bun venit pe Tamago! Pentru a finaliza înregistrarea și a avea acces complet la platformă,
        te rugăm să verifici adresa de email făcând clic pe butonul de mai jos.
      </p>
      <div style={{ textAlign: 'center', margin: '30px 0' }}>
        <Button asChild style={{ backgroundColor: '#3b82f6', color: 'white', padding: '12px 24px', textDecoration: 'none', borderRadius: '6px' }}>
      ...
      <p style={{ color: '#999', fontSize: '12px', marginTop: '30px' }}>
        Dacă nu te-ai înregistrat pe Tamago, ignoră acest email.
      </p>
    </div>
  );
}