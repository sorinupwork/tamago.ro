import { Calendar, Wrench, FileText, Droplet, ChevronDownIcon } from 'lucide-react';
...
export function CarHistoryHighlights({ car, features }: CarHistoryHighlightsProps) {
  // Mock history items based on car data;
  const historyItems = [
    {
      icon: FileText,
      label: 'RAR',
