    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Verifică-ți contul pentru a crește încrederea și a debloca funcții suplimentare
          </DialogDescription>
        </DialogHeader>
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {isEmailVerified
                      ...
                      : 'Verifică-ți adresa de email pentru securitate crescută.'
                    }
                  </p>
                </div>
                {isEmailVerified ? (
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-base flex items-center">
                ...
                Verificare Socială (În curând)
              </CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-muted-foreground">
                Conectează-ți conturile sociale pentru verificare suplimentară.
