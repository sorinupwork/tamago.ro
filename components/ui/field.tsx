...
function FieldLabel({ className, lift = true, ...props }: React.ComponentProps<typeof Label> & { lift?: boolean }) {
  return (
    <Label
      ...
      className={cn(
        'group/field-label peer/field-label flex w-fit gap-2 leading-snug group-data-[disabled=true]/field:opacity-50 mb-0.5',
        lift && 'transition-transform duration-300 ease-in-out group-focus-within/field:-translate-y-2',
